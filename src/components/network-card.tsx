...
export function NetworkCard({ network }: NetworkCardProps) {
  ...
  return (
    <Link href={href} className="group block">
      <Card className="overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-primary/30 border border-border/80 bg-secondary/50 flex items-center justify-center aspect-video">
