...
export const networksConfig: NetworkConfig[] = [
    ...
    { name: 'The CW', logo_path: 'https://media.themoviedb.org/t/p/w154/hEpcdJ4O6eitG9ADSnDXNUrlovS.png', networkIds: [71] },
    { name: 'MGM+', logo_path: 'https://media.themoviedb.org/t/p/w154/89TXvQzvoKvyqD9EEogohzMJ8D6.png', networkIds: [6219] },
